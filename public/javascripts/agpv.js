...
async function populateFrameworksPanel( objs ) {
	...
	itemsHtml += "<a id='sidepanelheader' href='#sidepanel' data-toggle='collapse'><h3 class='panel-title'>Choose Framework " + $(".collapse").collapse + "</h3>"//($(".collapse").collapse=='hide'?$('#selectedFramework').innerHTML:"") + "</h3>";
