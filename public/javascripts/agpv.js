...
function populateCurrentSearchTermsDiv(searchterms) {
	...
	curTermsArray.forEach( element => {
		...
		currentTermsString += "<a class='activekeywords plain' onclick='javascript:removeActiveSearchterm(this);'> <span class='glyphicon glyphicon-remove-circle'></span>" + "&nbsp;" + decodeURI(element) + "</a>"
	});
	...
	document.getElementById('currentsearchterms').style.display = 'none';;
}
