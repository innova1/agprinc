...
async function populateFrameworksPanel( objs ) {
	...
	itemsHtml += "<a id='sidepanelheader' style='display: inline;' href='#sidepanel' data-toggle='collapse'><h3 class='panel-title'>Framework <div id='displaySelectedFramework'></div></h3></a>";
