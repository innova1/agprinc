...
async function populateFrameworksPanel( objs ) {
	...
	itemsHtml += "<a id='sidepanelheader' href='#sidepanel' data-toggle='collapse'><h3 class='panel-title'>Choose Framework " + ($("$sidepanel").hasClass('in')?"":('#selectedFramework').innerHTML) + "</h3>";
