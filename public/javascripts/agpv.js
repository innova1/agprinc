...
async function populateFrameworksPanel( objs ) {
	...
	itemsHtml += "<a id='sidepanelheader' href='#sidepanel' data-toggle='collapse'><h3 class='panel-title'>Framework <div id='displaySelectedFramework' style='display: inline;'></div></h3></a>";
