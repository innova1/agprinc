...
function getDataArray() {
    ...
    pObj[++i]  = { id: '1' , type: 'principle', framework: 'daddiscipline', shortdescription: 'delivery continuously', principle: 'Deliver continuously' };
    pObj[++i]  = { id: '2' , type: 'principle', framework: 'daddiscipline', shortdescription: 'visualize workflow', principle: 'Visualize workflow' };
    pObj[++i]  = { id: '3' , type: 'principle', framework: 'daddiscipline', shortdescription: 'whole teams', principle: 'Whole teams' };
    pObj[++i]  = { id: '4' , type: 'principle', framework: 'daddiscipline', shortdescription: 'stable teams', principle: 'Stable teams' };
    pObj[++i]  = { id: '5' , type: 'principle', framework: 'daddiscipline', shortdescription: 'trust & respect', principle: 'Trust & respect' };
    pObj[++i]  = { id: '6' , type: 'principle', framework: 'daddiscipline', shortdescription: 'mastery', principle: 'Master your craft' };
    pObj[++i]  = { id: '7' , type: 'principle', framework: 'daddiscipline', shortdescription: 'technical excellence', principle: 'Technical excellence' };
    pObj[++i]  = { id: '8' , type: 'principle', framework: 'daddiscipline', shortdescription: 'collaboration', principle: 'Collaboration' };
    pObj[++i]  = { id: '9' , type: 'principle', framework: 'daddiscipline', shortdescription: 'measure wisely', principle: 'Measure wisely' };
    pObj[++i]  = { id: '10', type: 'principle', framework: 'daddiscipline', shortdescription: 'transparency', principle: 'Transparency' };
    pObj[++i]  = { id: '11', type: 'principle', framework: 'daddiscipline', shortdescription: 'learn continuously', principle: 'Learn continuously' };
    pObj[++i]  = { id: '12', type: 'principle', framework: 'daddiscipline', shortdescription: 'purposeful experiments', principle: 'Purposeful experiments' };
