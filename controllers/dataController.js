...
function getDataArray() {
    ...
    pObj[++i]  = { id: '11', type: 'principle', framework: 'manifesto', shortdescription: 'best design from the teams', principle: 'The best architectures, requirements, and designs emerge from self-organizing teams.' };
    ...
    pObj[++i]  = { id: '1' , type: 'principle', framework: 'dadmanifesto', shortdescription: 'continuous delivery', principle: 'Our highest priority is to satisfy the stakeholder through early and continuous delivery of valuable solutions.' };
    pObj[++i]  = { id: '2' , type: 'principle', framework: 'dadmanifesto', shortdescription: 'welcome change', principle: 'Welcome emerging requirements, even late in the solution delivery lifecycle. Agile processes harness change for the customer’s competitive advantage.' };
    pObj[++i]  = { id: '3' , type: 'principle', framework: 'dadmanifesto', shortdescription: 'deliver continuously', principle: 'Deliver valuable solutions continuously, from many times a day to every few weeks, with the aim to increase the frequency over time.' };
    pObj[++i]  = { id: '4' , type: 'principle', framework: 'dadmanifesto', shortdescription: 'daily with stakeholders', principle: 'Stakeholders and developers must actively collaborate to deliver outcomes that will delight our organization’s customers.' };
    pObj[++i]  = { id: '5' , type: 'principle', framework: 'dadmanifesto', shortdescription: 'motivated individuals', principle: 'Build teams around motivated individuals. Give them the environment and support they need, and trust them to get the job done.' };
    pObj[++i]  = { id: '6' , type: 'principle', framework: 'dadmanifesto', shortdescription: 'face-to-face conversation', principle: 'The most efficient and effective method of conveying information to and within a delivery team is face-to-face conversation, ideally around a whiteboard.' };
    pObj[++i]  = { id: '7' , type: 'principle', framework: 'dadmanifesto', shortdescription: 'measure is delivery of value', principle: 'Continuous delivery of value is the primary measure of progress.' };
    pObj[++i]  = { id: '8' , type: 'principle', framework: 'dadmanifesto', shortdescription: 'sustainability', principle: 'Agile processes promote sustainable delivery. The sponsors, developers, and users should be able to maintain a constant pace indefinitely.' };
    pObj[++i]  = { id: '9' , type: 'principle', framework: 'dadmanifesto', shortdescription: 'technical excellence', principle: 'Continuous attention to technical excellence and good design enhances agility.' };
    pObj[++i]  = { id: '10', type: 'principle', framework: 'dadmanifesto', shortdescription: 'simplicity', principle: 'Simplicity – the art of maximizing the amount of work not done – is essential.' };
    pObj[++i]  = { id: '11', type: 'principle', framework: 'dadmanifesto', shortdescription: 'best design from the teams', principle: 'The best architectures, requirements, and designs emerge from self-organizing teams enabled by organizational roadmaps and support.' };
    pObj[++i]  = { id: '12', type: 'principle', framework: 'dadmanifesto', shortdescription: 'continuous improvement', principle: 'The team continuously reflects on how to become more effective, then experiments, learns, and adjusts its behavior accordingly.' };
    pObj[++i]  = { id: '13', type: 'principle', framework: 'dadmanifesto', shortdescription: 'leverage and evolve enterprise assets', principle: 'Leverage and evolve the assets within your enterprise, collaborating with the people responsible for those assets to do so.' };
    pObj[++i]  = { id: '14', type: 'principle', framework: 'dadmanifesto', shortdescription: 'visualize work', principle: 'Visualize work to produce a smooth delivery flow and keep work-in-progress (WIP) to a minimum.' };
    pObj[++i]  = { id: '15', type: 'principle', framework: 'dadmanifesto', shortdescription: 'evolve the entire enterprise', principle: 'Evolve the entire enterprise, not just individuals and teams, to support agile, non-agile, and hybrid teams.' };
    pObj[++i]  = { id: '16', type: 'principle', framework: 'dadmanifesto', shortdescription: 'automated measures for data-led decisions', principle: 'We measure our work and its outcomes, preferring automated measures over manually gathered ones, to make data-led decisions.' };
    pObj[++i]  = { id: '17', type: 'principle', framework: 'dadmanifesto', shortdescription: 'transparency', principle: 'We provide complete transparency to our stakeholders in everything we do and produce, to enable open and honest conversations and effective governance of our team.' };
